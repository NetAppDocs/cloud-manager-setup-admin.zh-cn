...
link:reference-networking-cloud-manager.html#outbound-internet-access["查看所需端点的列表"]。
...
image:screenshot-connector-disk-encryption.png["在 AWS 中创建 Connector 时显示磁盘加密选项的屏幕截图。"]
...
link:task-managing-netapp-accounts.html["了解如何筛选租户服务的时间线"]。
